                    ...
                    <div className="relative text-center w-full flex justify-center flex-wrap">
                        ...
                        <div className="w-full">
                            ...
                            <p className="text-white/60">
                                ...
                                Next.js web applications using Appwrite, an
                                open-source backend server. Follow along as we
                                demonstrate the step-by-step process of setting
                                up and implementing authentication
                                functionality, ensuring the highest level of
